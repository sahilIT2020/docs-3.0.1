...
Attributes, as they pertain to SSO, are covered more thoroughly in the [SAML Attributes](./saml.md#saml-attributes) and [OpenID Connect Scopes](./openid-connect/#scopes) sections of the docs.
